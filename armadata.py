...
class ARMAVolumeDataset:
    ...
    def process_data(self):
        ...
        print(f'[INFO] raw_data contains {len(missing_rows)} missing observations')
        if len(missing_rows) > 0:
            print("[INFO] FILLED timestamps:")
            print(missing_rows.index.to_list())

        # CHANGED FORWARD FILL
        raw_data['volume'] = raw_data['volume'].fillna(1e-8)                            
...
# UNCOMMENT TO SEE THE FULL FILE
